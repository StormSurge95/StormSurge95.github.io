 ...
 * 
 *      Runnign test program (in JavaScript):
 * 
...
// removeMany(callback[, limit]) will execute the callback function for each item of
...
// Look at the top fo the queue (one of the smallest elements) without removing it
...
// recover unused memory (for long-runnign priority queues)
